"""
Django settings for floral_recipe_42725 project.
...
ROOT_URLCONF = 'floral_recipe_42725.urls'
...
WSGI_APPLICATION = 'floral_recipe_42725.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_recipe_42725 API",
    "DESCRIPTION": "API documentation for floral_recipe_42725 App",
    "VERSION": "v1",
}
